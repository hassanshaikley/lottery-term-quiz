...
const newMatch = match.filter(str => str != '')

const meanings = newMatch.filter((str, index) => index % 2 == 1)

const words = newMatch.filter((str, index) => index % 2 == 0)
